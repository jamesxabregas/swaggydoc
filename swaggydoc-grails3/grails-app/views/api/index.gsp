...
<div id='header'>
    <div class="swagger-ui-wrap">
        <a id="logo" href="${g.createLink(controller: 'api')}"><asset:image class="logo__img" alt="swagger" height="30" width="30" src="swagger/logo_small.png" /><span class="logo__title">swagger</span></a>
        <form id='api_selector'>
            <div class='input'><input placeholder="${g.createLink(controller: 'api', action: 'resources')}" id="input_baseUrl" name="baseUrl" type="text"/></div>
