...
class Api20Controller {

    def swaggy20DataService
    ...
    def resources() {
        ...
        render swaggy20DataService.resources() as JSON
    }
    ...
    def show(String id) {
        ...
        ControllerDefinition controllerDefinition = swaggy20DataService.apiDetails(id)
