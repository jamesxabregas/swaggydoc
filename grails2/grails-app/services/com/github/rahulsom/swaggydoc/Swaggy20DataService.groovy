...
//        grailsApplication.getArtefactByLogicalPropertyName('Controller', urlMappings[2].controllerName)
        ...
        def inferredTypes = inferTypesBetter(theController)
    ...
    private inferTypesBetter(GrailsControllerClass theController) {

        def types = grailsApplication.domainClasses.find { it.logicalPropertyName == theController.logicalPropertyName }?.clazz
