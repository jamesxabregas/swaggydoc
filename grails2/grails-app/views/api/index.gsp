...
<div id='header'>
    <div class="swagger-ui-wrap">
        <a id="logo" href="${g.createLink(controller: 'api')}"><asset:image class="logo__img" alt="swagger" height="30" width="30" src="images/logo_small.png" /><span class="logo__title">swagger</span></a>
